...
(facts "gen-structure"
  (facts "default structure"
    (let [default-structure (DefaultPailStructure.)]
      ...
      (fact "getTapMapper returns tap mapper function"
        (.getTapMapper default-structure) => tapmapper/nulltapmapper)

      (fact "TapMapper returns empty set by default."
            ((.getTapMapper default-structure) ["some" "path"]) => {})
